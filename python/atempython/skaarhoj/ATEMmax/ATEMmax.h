...
private:
      void _parseGetCommands(const char *cmdStr);
                  ...
                  long atemKeyerFlyKeyFrameSizeX[2][4][3];
                  long atemKeyerFlyKeyFrameSizeY[2][4][3];
                  long atemKeyerFlyKeyFramePositionX[2][4][3];
                  long atemKeyerFlyKeyFramePositionY[2][4][3];
                  long atemKeyerFlyKeyFrameRotation[2][4][3];
...
public:
                  ...
                  long getKeyerFlyKeyFrameSizeX(uint8_t mE, uint8_t keyer, uint8_t keyFrame);
                  long getKeyerFlyKeyFrameSizeY(uint8_t mE, uint8_t keyer, uint8_t keyFrame);
                  long getKeyerFlyKeyFramePositionX(uint8_t mE, uint8_t keyer, uint8_t keyFrame);
                  long getKeyerFlyKeyFramePositionY(uint8_t mE, uint8_t keyer, uint8_t keyFrame);
                  long getKeyerFlyKeyFrameRotation(uint8_t mE, uint8_t keyer, uint8_t keyFrame);
